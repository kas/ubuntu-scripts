...
echo 'alias t="~/repos/kubuntu-scripts/time-theme/time-theme"' >> ~/.bashrc
echo 'alias td="~/repos/kubuntu-scripts/time-theme/time-theme --dark"' >> ~/.bashrc
echo 'alias tl="~/repos/kubuntu-scripts/time-theme/time-theme --light"' >> ~/.bashrc